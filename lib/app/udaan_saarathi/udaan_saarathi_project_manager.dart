...
import 'package:variant_dashboard/app/udaan_saarathi/pm_board.dart';
...
import '../variant_dashboard/features/variants/presentation/widgets/variant_preview.dart' show VariantPreview;


class UdaanSaarathiProjectManager extends StatelessWidget {
  const UdaanSaarathiProjectManager({
    super.key,
  });
            ...
            child: Padding(
              ...
              child: ScreenUtilInit(
                ...
                builder: (context, child) => MaterialApp(
                  ...
                  home: VariantPreview(variant: VariantItem(
          name: 'Home V1 - Bassic',
