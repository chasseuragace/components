...
final rHomepageRepositoryProvider = Provider((ref) {
  ...
  return HomepageRepositoryFake(
      localDataSource: local, remoteDataSource: remote);
});

final localDataHomepageSourceProvider =
    Provider<HomepageLocalDataSource>((ref) {
  return HomepageLocalDataSourceImpl();
});

final remoteDataHomepageSourceProvider =
    Provider<HomepageRemoteDataSource>((ref) {
