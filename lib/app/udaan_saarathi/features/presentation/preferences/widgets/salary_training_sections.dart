      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Rs ${(salaryRange['min']!).round()}',  // Convert USD to NPR (1 USD ≈ 133 NPR)
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Rs ${(salaryRange['max']!).round()}',  // Convert USD to NPR (1 USD ≈ 133 NPR)
                      style: const TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.w700,
                        color: Color(0xFFDC2626),
          ...
          RangeSlider(
            ...
            labels: RangeLabels(
              'Rs ${(salaryRange['min']!).round()}',
              'Rs ${(salaryRange['max']!).round()}',
            ),
            onChanged: (values) {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              '${(min).round()}-${(max).round()}',  // Convert to NPR
              style: TextStyle(
                fontSize: 10,
