...
class AgencyListingScreen extends StatefulWidget {
  const AgencyListingScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _AgencyListingScreenState createState() => _AgencyListingScreenState();
}

class _AgencyListingScreenState extends State<AgencyListingScreen> {
